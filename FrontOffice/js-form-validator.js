	...
	Protected.prototype = {
		...
		messages: {
		    ...
		    en: {
		        ...
		        integer: {
		            empty: 'Insira um número inteiro',
		            incorrect: 'Valor inteiro incorreto'
		        },
		        float: {
		            empty: 'Insira um número com casas decimais',
		            incorrect: 'Valor inserido incorreto'
		        },
		        min: {
		            empty: 'Insira mais carateres',
		            incorrect: 'Insira mais carateres'
		        },
		        max: {
		            empty: 'Insira menos carateres',
		            incorrect: 'Insira menos carateres'
		        },
		        between: {
		            empty: 'Insira valores entre {0}-{1}',
		            incorrect: 'Insira valores entre{0}-{1}'
		        },
		        name: {
		        ...
		        lastname: {
		            empty: 'Insira o seu último nome, por favor',
		            incorrect: 'Último nome incorreto'
		        },
		        phone: {
		        ...
		        email: {
		            empty: 'Porfavor, insira o seu email',
		            incorrect: 'Email inválido'
		        },
		        length: {
		            empty: 'Por favor, insira um minimo de {0} carateres e um máximo de {1}',
		            incorrect: 'Incorreto. Insira um minimo de {0} carateres e um maximo de {1}'
		        },
		        minlength: {
		            empty: 'Insira, por favor, um minimo de {0} carateres',
		            incorrect: 'Inseriu menos do que {0} carateres'
		        },
		        maxlength: {
		            empty: 'Insira, por favor, um máximo de {0} carateres',
		            incorrect: 'Inseriu mais do que {0} carateres'
		        },
		        maxfilesize: {
		            empty: 'Insira um ficheiro mais pequeno do que {0} {1}',
		            incorrect: 'O tamanho de um ou mais ficheiros é maior do que {0} {1}'
		        },
		        fileextension: {
		            empty: 'Selecione um ficheiro',
		            incorrect: 'Um ou mais ficheiros não são suportados'
		        },
		    }
		},
