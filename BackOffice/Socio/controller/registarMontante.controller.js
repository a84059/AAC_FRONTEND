const urlBase13 = "https://b202-back-webitcloud.c9users.io";
let isNew13 = true;
    ...
    document.getElementById("registarMontante").addEventListener("click", function() {
        setTimeout(function() {
            //do something once
            elementForm13 = document.getElementById("registarmontante");
            //chama a função para atualizar os users
            renderMontante();
            //adicionar função de validação ao formulário
            validator13();
        }, 1000);
        elementForm13.onsubmit = function(e) {
    ...
    //função de validação
    function validator13() {
        let validator13 = new Validator(document.querySelector('form[id="registarmontante"]'), function
    ...
    function inicio(isNew13) {
        ...
        if (isNew13 == true) {
            ...
            fetch(`${urlBase13}/montante/${valuetID}`, {
                headers: {
                    "Content-Type": "application/json"
                },
                method: "PUT",
    ...
    const renderMontante = async() => {
        ...
        const renderMontante = document.getElementById("result13");
        ...
        const response = await fetch(`${urlBase13}/montante`)
