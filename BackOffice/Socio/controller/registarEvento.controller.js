    ...
    document.getElementById("registarEvento").addEventListener("click", function() {
        setTimeout(function() {
            //do something once
            elementForm12 = document.getElementById("registarevento");
            //chama a função para atualizar os users
            renderEventos();
            //adicionar função de validação ao formulário
            validator12()
        }, 1000);
        elementForm12.onsubmit = function(e) {
 ...
 //função de validação
    function validator12() {
        let validator12 = new Validator(document.querySelector('form[id="registarevento"]'), function(err, res) {
    ...
    const renderEventos = async() => {
        ...
        const renderEvento = document.getElementById("result12");
        ...
        strHtml += "<tr style='text-align:center'><th>ID</th><th>Nome</th><th>Morada</th><th>Data Inicio</th><th>Data Fim</th><th>Hora</th></tr></thead><tbody>";
