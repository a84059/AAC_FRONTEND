    ...
    document.getElementById("registarEvento").addEventListener("click", function() {
        setTimeout(function() {
            //do something once
            elementForm2 = document.getElementById("registarevento");
 ...
 //função de validação
    function validator2() {
        let validator2 = new Validator(document.querySelector('form[id="registarevento"]'), function(err, res) {
    ...
    const renderEventos = async() => {
        ...
        const renderEvento = document.getElementById("result1");
