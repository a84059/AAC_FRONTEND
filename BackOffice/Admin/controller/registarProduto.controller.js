...
let elementForm5;
    ...
    document.getElementById("registarProduto").addEventListener("click", function() {
        setTimeout(function() {
            //do something once
            elementForm5 = document.getElementById("registarproduto");
        ...
        elementForm5.onsubmit = function(e) {
    ...
    //função de validação
    function validator5() {
        let validator5 = new Validator(document.querySelector('form[id="registarproduto"]'), function(err, res) {
    ...
    const renderProdutos = async() => {
        ...
        const renderProdutos = document.getElementById("result2");
        ...
        strHtml += "<tr style='text-align:center'><th>ID</th><th>Nome</th><th>Categoria</th><th>Preço</th><th>Stock</th><th>Disponibilidade</th><th>Editar</th><th>Remover</th></tr></thead><tbody>";
        ...
        for (const produto of produtos) {
            ...
            strHtml += `
                <tr>
                    ...
                    <td name="edit">
                        <button class='fas fa-edit edit' id="${produto.id_produto}">
                        </td>
                        <td name="remove"><button class='fas fa-trash-alt remove' id="${produto.id_produto}">
                    </td>
                </tr>
            `;
            i++;
